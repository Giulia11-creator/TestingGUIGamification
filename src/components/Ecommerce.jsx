        ...
        <nav class="flex" aria-label="Breadcrumb">
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            <li class="inline-flex items-center">
              <a href="#" class="inline-flex items-center text-sm font-medium text-black-700">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="#" class="inline-flex items-center text-sm font-medium text-black-700">Products</a>
              </div>
            </li>
            <li aria-current="page">
              <div class="flex items-center">
                ...
                <span class="inline-flex items-center text-sm font-medium text-black-700">Electronics</span>
              </div>
            </li>
          </ol>
        </nav>
    ...
    <div class="rounded-lg border border-white-200 bg-white p-6 shadow-sm">
      ...
      <div class="rounded-lg border border-white-200 bg-white p-6 shadow-sm">
        ...
        <div class="pt-6">
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-black-900">Apple iMac 27", 1TB HDD, Retina 5K Display, M3 Max</a>
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-black-900">$1,699</p>

            <button type="button" class="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-black">
              <svg class="-ms-2 me-2 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4h1.5L8 16m0 0h8m-8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm.75-3H7.5M11 7H6.312M17 4v6m-3-3h6" />
              </svg>
              Add to cart
