        ...
        <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
          <div className="rounded-lg border border-white-200 bg-white p-6 shadow-sm">
            <div className="h-56 w-full">
              <a href="#">
                <img id="imacPhoto" className="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg" alt="" />
              </a>
            </div>
            <div className="pt-6">
              ...
              <a href="#" id="imacTitle" className="text-lg font-semibold leading-tight text-black-900">Apple iMac 27", 1TB HDD, Retina 5K Display, M3 Max</a>
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <p className="text-sm font-medium text-black-900">5.0</p>
                <p className="text-sm font-medium text-black-900">(455)</p>
              </div>

              <div className="mt-4 flex items-center justify-between gap-4">
                <p id="imacPrice" className="text-2xl font-extrabold leading-tight text-black-900">$1699,00</p>
          ...
          <div className="rounded-lg border border-white-200 bg-white p-6 shadow-sm">
            <div className="h-56 w-full">
              <a href="#">
                <img id='matebookPhoto' className="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/macbook-pro-dark.svg" alt="" />
              </a>
            </div>
            <div className="pt-6">
              <div className="mb-4 flex items-center justify-between gap-4">
              ...
              <a id='matebookTitle' href="#" className="text-lg font-semibold leading-tight text-black-900">HUAWEI MateBook X Pro U7-155H 32GB +1TB Morandi Blue Windows 11 Pro</a>
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <p className="text-sm font-medium text-black-900">5.0</p>
                <p className="text-sm font-medium text-black-900">(1000)</p>
              </div>

              <div className="mt-4 flex items-center justify-between gap-4">
                <p id='matebookPrice' className="text-2xl font-extrabold leading-tight text-black-900">$1400,00</p>
          ...
          <div className="rounded-lg border border-white-200 bg-white p-6 shadow-sm">
            <div className="h-56 w-full">
              <a href="#">
                <img id="watchPhoto" className="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/apple-watch-dark.svg" alt="" />
              </a>
            </div>
            <div className="pt-6">
              <div className="mb-4 flex items-center justify-between gap-4">
              ...
              <a href="#" id="watchTitle" className="text-lg font-semibold leading-tight text-black-900">Apple Watch Series 9 GPS 41mm Smartwatch con cassa in alluminio color mezzanotte e Cinturino Sport mezzanotte </a>
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <p className="text-sm font-medium text-black-900">5.0</p>
                <p className="text-sm font-medium text-black-900">(333)</p>
              </div>

              <div className="mt-4 flex items-center justify-between gap-4">
                <p id="watchPrice" className="text-2xl font-extrabold leading-tight text-black-900">$500,00</p>
          ...
          <div className="rounded-lg border border-white-200 bg-white p-6 shadow-sm">
            <div className="h-56 w-full">
              <a href="#">
                <img id="ipadPhoto" className="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ipad-keyboard-dark.svg" alt="" />
              </a>
            </div>
            <div className="pt-6">
              <div className="mb-4 flex items-center justify-between gap-4">
              ...
              <a href="#" id="ipadTitle" className="text-lg font-semibold leading-tight text-black-900">Apple iPad Pro 11'': Chip M4 Progettato per Apple Intelligence, display Ultra Retina XDR, 256GB</a>
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <p className="text-sm font-medium text-black-900">5.0</p>
                <p className="text-sm font-medium text-black-900">(1355)</p>
              </div>

              <div className="mt-4 flex items-center justify-between gap-4">
                <p id="ipadPrice" className="text-2xl font-extrabold leading-tight text-black-900">$1200,00</p>
          ...
          <div className="rounded-lg border border-white-200 bg-white p-6 shadow-sm">
            <div className="h-56 w-full">
              <a href="#">
                <img id="iphonePhoto" className="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-dark.svg" alt="" />
              </a>
            ...
            <div className="pt-6">
              ...
              <a href="#" id="iphoneTitle" className="text-lg font-semibold leading-tight text-black-900">Apple iPhone 16 128 GB: Telefono 5G con Controllo fotocamera, chip A18</a>
              ...
              <div className="mt-4 flex items-center justify-between gap-4">
                <p id="iphonePrice" className="text-2xl font-extrabold leading-tight text-black-900">$850,00</p>
          ...
          <div className="rounded-lg border border-white-200 bg-white p-6 shadow-sm">
            <div className="h-56 w-full">
              <a href="#">
                <img id="ps5Photo" className="mx-auto hidden h-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ps5-dark.svg" alt="" />
              </a>
            </div>
            <div className="pt-6">
              <div className="mb-4 flex items-center justify-between gap-4">
              ...
              <a href="#" id="ps5Title" className="text-lg font-semibold leading-tight text-black-900">Playstation 5 Console Edizione Digital Slim</a>
              ...
              <div className="mt-4 flex items-center justify-between gap-4">
                <p id="ps5Price" className="text-2xl font-extrabold leading-tight text-black-900">$412,00</p>
